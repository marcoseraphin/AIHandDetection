...
namespace MLHandDetection {
	/// <summary>
	/// Model Prediction Input Type
	/// </summary>
	public class HandDetectionModelInput : NSObject, IMLFeatureProvider
	{
		...
		public HandDetectionModelInput (CVPixelBuffer data)
		{
			if (data == null)
	...
	/// </summary>
	public class HandDetectionModelOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public HandDetectionModelOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	/// </summary>
	public class HandDetectionModel : NSObject
	{
		readonly MLModel model;

		static NSUrl GetModelUrl ()
		{
			return NSBundle.MainBundle.GetUrlForResource ("HandDetectionModel", "mlmodelc");
		}

		public HandDetectionModel ()
		{
			NSError err;
		...
		HandDetectionModel (MLModel model)
		{
			this.model = model;
		}

		public static HandDetectionModel Create (NSUrl url, out NSError error)
		{
			if (url == null)
			...
			return new HandDetectionModel (model);
		}

		public static HandDetectionModel Create (MLModelConfiguration configuration, out NSError error)
		{
		...
		public static HandDetectionModel Create (NSUrl url, MLModelConfiguration configuration, out NSError error)
		{
			if (url == null)
				throw new ArgumentNullException (nameof (url));
		...
		/// </summary>
		/// <param name="input">an instance of HandDetectionModelInput to predict from</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public HandDetectionModelOutput GetPrediction (HandDetectionModelInput input, out NSError error)
		{
			if (input == null)
			...
			return new HandDetectionModelOutput (lossValue, classLabelValue);
		}
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public HandDetectionModelOutput GetPrediction (HandDetectionModelInput input, MLPredictionOptions options, out NSError error)
		{
			if (input == null)
				throw new ArgumentNullException (nameof (input));
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public HandDetectionModelOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
			var input = new HandDetectionModelInput (data);
		...
		/// <param name="options">prediction options</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public HandDetectionModelOutput GetPrediction (CVPixelBuffer data, MLPredictionOptions options, out NSError error)
		{
			var input = new HandDetectionModelInput (data);
